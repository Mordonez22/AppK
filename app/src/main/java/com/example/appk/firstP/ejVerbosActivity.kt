...
class ejVerbosActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ej_verbos)
        ...
        palabras.text = "Leer"
        option1RadioButton.text = "Tze’enïk"
        option2RadioButton.text = "Sik’inïk"
        option3RadioButton.text = "käq"

        palabras2.text = "Cantar"
        option1RadioButton2.text = "To’onïk"
        option2RadioButton2.text = "Ch’ab’enïk"
        option3RadioButton2.text = "B’ixanïk"

        palabras3.text = "Trabajar"
        option1RadioButton3.text = "Samajxïk"
        option2RadioButton3.text = "B’oninïk"
        option3RadioButton3.text = "Kaqkoj"
        ...
        checkButton.setOnClickListener {
            ...
            val correctTranslation = "Sik’inïk"
        ...
        checkButton2.setOnClickListener {
            ...
            val correctTranslation = "B’ixanïk"
            val userTranslation = selectedOption.text.toString()
        ...
        checkButton3.setOnClickListener {
            ...
            val correctTranslation = "Samajxïk"
            val userTranslation = selectedOption.text.toString()
