...
class auColoresActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_au_colores)
        ...
        option1RadioButton.text = "Rojo"
        option2RadioButton.text = "Negro"
        option3RadioButton.text = "Anaranjado"

        audio2.text = "Reproducir Audio"
        option1RadioButton2.text = "Celeste"
        option2RadioButton2.text = "Blanco"
        option3RadioButton2.text = "Morado"

        audio3.text = "Reproducir Audio"
        option1RadioButton3.text = "Amarillo"
        option2RadioButton3.text = "Café"
        option3RadioButton3.text = "Blanco"
        ...
        checkButton2.setOnClickListener {
            ...
            val correctTranslation = "Celeste"
            val userTranslation = selectedOption.text.toString()
        ...
        checkButton3.setOnClickListener {
            ...
            val correctTranslation = "Amarillo"
            val userTranslation = selectedOption.text.toString()
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.negro)
        mediaPlayer2 = MediaPlayer.create(this, R.raw.celeste)
