...
class adjetivosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.nuevo)
        mediaPlayer2 = MediaPlayer.create(this, R.raw.suave)
        mediaPlayer3 = MediaPlayer.create(this, R.raw.grande)
        mediaPlayer4 = MediaPlayer.create(this, R.raw.acido)
        mediaPlayer5 = MediaPlayer.create(this, R.raw.salado)
        mediaPlayer6 = MediaPlayer.create(this, R.raw.caliente)
        mediaPlayer7 = MediaPlayer.create(this, R.raw.bueno)
        mediaPlayer8 = MediaPlayer.create(this, R.raw.pequeno)
        mediaPlayer9 = MediaPlayer.create(this, R.raw.dulce)
        mediaPlayer10 = MediaPlayer.create(this, R.raw.viejo)
