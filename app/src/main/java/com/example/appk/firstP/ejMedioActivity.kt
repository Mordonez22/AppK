...
class ejMedioActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ej_medio)
        ...
        palabras.text = "Facebook"
        option1RadioButton.text = "wachwuj"
        option2RadioButton.text = "q’ëq"
        option3RadioButton.text = "xib’al"

        palabras2.text = "Televisión"
        option1RadioButton2.text = "achib’il"
        option2RadioButton2.text = "nimaqul"
        option3RadioButton2.text = "taluwäch"

        palabras3.text = "Carta"
        option1RadioButton3.text = "me’al"
        option2RadioButton3.text = "Xarxöj"
        option3RadioButton3.text = "taqowul"
        ...
        checkButton.setOnClickListener {
            ...
            val correctTranslation = "wachwuj"
        ...
        checkButton2.setOnClickListener {
            ...
            val correctTranslation = "taluwäch"
            val userTranslation = selectedOption.text.toString()
        ...
        checkButton3.setOnClickListener {
            ...
            val correctTranslation = "taqowul"
            val userTranslation = selectedOption.text.toString()
