...
class auVerbosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_au_verbos)
        ...
        option1RadioButton.text = "Visitar"
        option2RadioButton.text = "Escribir"
        option3RadioButton.text = "Contar"

        audio2.text = "Reproducir Audio"
        option1RadioButton2.text = "Enseñar"
        option2RadioButton2.text = "Trabajar"
        option3RadioButton2.text = "Escuchar"

        audio3.text = "Reproducir Audio"
        option1RadioButton3.text = "Colorear"
        option2RadioButton3.text = "Hacer"
        option3RadioButton3.text = "Leer"
        ...
        checkButton.setOnClickListener {
            ...
            val correctTranslation = "Visitar"
        ...
        checkButton2.setOnClickListener {
            ...
            val correctTranslation = "Escuchar"
            val userTranslation = selectedOption.text.toString()
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.visitar)
        mediaPlayer2 = MediaPlayer.create(this, R.raw.escuchar)
        mediaPlayer3 = MediaPlayer.create(this, R.raw.hacer)
