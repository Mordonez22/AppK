...
class auDiasActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_au_dias)
        ...
        option1RadioButton.text = "Sábado"
        option2RadioButton.text = "Domingo"
        option3RadioButton.text = "Jueves"

        audio2.text = "Reproducir Audio"
        option1RadioButton2.text = "Viernes"
        option2RadioButton2.text = "Martes"
        option3RadioButton2.text = "Lunes"

        audio3.text = "Reproducir Audio"
        option1RadioButton3.text = "Martes"
        option2RadioButton3.text = "Miércoles"
        option3RadioButton3.text = "Domingo"
        ...
        checkButton3.setOnClickListener {
            ...
            val correctTranslation = "Miércoles"
            val userTranslation = selectedOption.text.toString()
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.sabado)
        mediaPlayer2 = MediaPlayer.create(this, R.raw.lunes)
