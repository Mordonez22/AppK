...
class ejProfesionesActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ej_profesiones)
        ...
        palabras.text = "Bombero"
        option1RadioButton.text = "te’ej"
        option2RadioButton.text = "tijonel"
        option3RadioButton.text = "chupunel"

        palabras2.text = "Doctor"
        option1RadioButton2.text = "achib’il"
        option2RadioButton2.text = "aq’omanel"
        option3RadioButton2.text = "alk´wal"

        palabras3.text = "Agricultor"
        option1RadioButton3.text = "tikonel"
        ...
        checkButton.setOnClickListener {
            ...
            val correctTranslation = "chupunel"
        ...
        checkButton2.setOnClickListener {
            ...
            val correctTranslation = "aq’omanel"
            val userTranslation = selectedOption.text.toString()
        ...
        checkButton3.setOnClickListener {
            ...
            val correctTranslation = "tikonel"
            val userTranslation = selectedOption.text.toString()
