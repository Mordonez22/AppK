...
class auNumerosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_au_numeros)
        ...
        option1RadioButton.text = "13"
        option2RadioButton.text = "11"
        option3RadioButton.text = "18"

        audio2.text = "Reproducir Audio"
        option1RadioButton2.text = "20"
        option2RadioButton2.text = "0"
        option3RadioButton2.text = "13"

        audio3.text = "Reproducir Audio"
        option1RadioButton3.text = "2"
        option2RadioButton3.text = "9"
        option3RadioButton3.text = "7"
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.once)
        mediaPlayer2 = MediaPlayer.create(this, R.raw.veinte)
        mediaPlayer3 = MediaPlayer.create(this, R.raw.siete)
