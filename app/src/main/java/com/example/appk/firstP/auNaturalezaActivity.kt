...
class auNaturalezaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_au_naturaleza)
        ...
        option1RadioButton.text = "Sol"
        option2RadioButton.text = "Árbol"
        option3RadioButton.text = "Montaña"

        audio2.text = "Reproducir Audio"
        option1RadioButton2.text = "Animales"
        option2RadioButton2.text = "Cielo"
        option3RadioButton2.text = "Tierra"

        audio3.text = "Reproducir Audio"
        option1RadioButton3.text = "Nube"
        option2RadioButton3.text = "Flores"
        option3RadioButton3.text = "Insectos"
        ...
        checkButton2.setOnClickListener {
            ...
            val correctTranslation = "Animales"
            val userTranslation = selectedOption.text.toString()
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.arbol)
        mediaPlayer2 = MediaPlayer.create(this, R.raw.animales)
        mediaPlayer3 = MediaPlayer.create(this, R.raw.flores)
