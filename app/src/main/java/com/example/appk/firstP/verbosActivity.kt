...
class verbosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        text8.text = "  Tijonïk"
        text9.text = "Escribir"
        text10.text = "  Tz’ib’anïk"
        text11.text = "Escuchar"
        text12.text = "  Ak’axanïk"
        text13.text = "Hacer"
        text14.text = "  B’anïk"
        text15.text = "Leer"
        text16.text = "  Sik’inïk"
        text17.text = "Trabajar"
        text18.text = "  Samajxïk"
        text19.text = "Visitar"
        text20.text = "  Ch’ab’enïk"
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.contar)
        mediaPlayer2 = MediaPlayer.create(this, R.raw.colorear)
        mediaPlayer3 = MediaPlayer.create(this, R.raw.cantar)
        mediaPlayer4 = MediaPlayer.create(this, R.raw.ensenar)
        mediaPlayer5 = MediaPlayer.create(this, R.raw.escribir)
        mediaPlayer6 = MediaPlayer.create(this, R.raw.escuchar)
        mediaPlayer7 = MediaPlayer.create(this, R.raw.hacer)
        mediaPlayer8 = MediaPlayer.create(this, R.raw.leer)
        mediaPlayer9 = MediaPlayer.create(this, R.raw.trabajar)
        mediaPlayer10 = MediaPlayer.create(this, R.raw.visitar)
