...
class ejNaturalezaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ej_naturaleza)
        ...
        option3RadioButton2.text = "raqän ya’"

        palabras3.text = "Tierra"
        option1RadioButton3.text = "ni’x"
        option2RadioButton3.text = "B’oninïk"
        option3RadioButton3.text = "ulew"
        ...
        checkButton2.setOnClickListener {
            ...
            val correctTranslation = "raqän ya’"
            val userTranslation = selectedOption.text.toString()
