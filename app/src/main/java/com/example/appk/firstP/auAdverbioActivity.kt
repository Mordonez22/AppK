...
class auAdverbioActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_au_adverbio)
        ...
        option1RadioButton.text = "Ayer"
        option2RadioButton.text = "Hoy"
        option3RadioButton.text = "Rápido"

        audio2.text = "Reproducir Audio"
        option1RadioButton2.text = "Ayer"
        option2RadioButton2.text = "Anteayer"
        option3RadioButton2.text = "Mañana"

        audio3.text = "Reproducir Audio"
        option1RadioButton3.text = "Despacio"
        option2RadioButton3.text = "Pasado Mañana"
        option3RadioButton3.text = "Ayer"
        ...
        checkButton2.setOnClickListener {
            ...
            val correctTranslation = "Anteayer"
            val userTranslation = selectedOption.text.toString()
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.rapido)
        mediaPlayer2 = MediaPlayer.create(this, R.raw.anteayer)
        mediaPlayer3 = MediaPlayer.create(this, R.raw.ayer)
