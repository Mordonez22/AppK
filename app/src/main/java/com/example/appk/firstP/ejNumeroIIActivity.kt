...
class ejNumeroIIActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ej_numero_iiactivity)
        ...
        palabras.text = "Cien"
        option1RadioButton.text = "Luq'ij"
        option2RadioButton.text = "Rox q'ij"
        option3RadioButton.text = "Wok’al"

        palabras2.text = "Ochenta"
        option1RadioButton2.text = "Kajk’al"
        option2RadioButton2.text = "Kajk’alLajuj"
        option3RadioButton2.text = "Saq'ij"

        palabras3.text = "Cincuenta"
        option1RadioButton3.text = "Junk’alLajuj"
        option2RadioButton3.text = "K’ak’alLajuj"
        option3RadioButton3.text = "K’ak’al"
        ...
        checkButton2.setOnClickListener {
            ...
            val correctTranslation = "Kajk’al"
            val userTranslation = selectedOption.text.toString()
        ...
        checkButton3.setOnClickListener {
            ...
            val correctTranslation = "K’ak’alLajuj"
            val userTranslation = selectedOption.text.toString()
