...
class auFamiliaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_au_familia)
        ...
        option1RadioButton.text = "Novio/a"
        option2RadioButton.text = "Mamá"
        option3RadioButton.text = "Abuela"

        audio2.text = "Reproducir Audio"
        option1RadioButton2.text = "Hija"
        option2RadioButton2.text = "Hermano"
        option3RadioButton2.text = "Papá"

        audio3.text = "Reproducir Audio"
        option1RadioButton3.text = "Hermana"
        option2RadioButton3.text = "Abuela"
        option3RadioButton3.text = "Abuelo"
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.mama)
        mediaPlayer2 = MediaPlayer.create(this, R.raw.hija)
