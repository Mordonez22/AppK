...
class MediosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        titleTextView.text = "MEDIOS DE COMUNICACIÓN "
        text1.text = "Teléfono"
        text2.text = "  oyonib’äl"
        text3.text = "Radio"
        text4.text = "  talutzij"
        text5.text = "Internet"
        text6.text = "  ya’l kematz’ib’"
        text7.text = "Correo Electrónico"
        text8.text = "  taqoya’l"
        text9.text = "Facebook"
        text10.text = "  wachwuj"
        text11.text = "Twitter"
        text12.text = "  ruya’l wachib’äl"
        text13.text = "Televisión"
        text14.text = "  taluwäch"
        text15.text = "Carta"
        text16.text = "  taqowul"
        text17.text = "Periódico"
        text18.text = "  talutz’ib’"
        text19.text = "Revistas"
        text20.text = "  ch’uti sik’iwuj"
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.telefono)
        mediaPlayer2 = MediaPlayer.create(this, R.raw.radio)
        mediaPlayer3 = MediaPlayer.create(this, R.raw.internet)
        mediaPlayer4 = MediaPlayer.create(this, R.raw.correo)
        mediaPlayer5 = MediaPlayer.create(this, R.raw.facebook)
        mediaPlayer6 = MediaPlayer.create(this, R.raw.twitter)
        mediaPlayer7 = MediaPlayer.create(this, R.raw.tele)
        mediaPlayer8 = MediaPlayer.create(this, R.raw.carta)
        mediaPlayer9 = MediaPlayer.create(this, R.raw.periodico)
        mediaPlayer10 = MediaPlayer.create(this, R.raw.revistas)
