...
class ejPronombreActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ej_pronombre)
        ...
        palabras.text = "Nosotros"
        option1RadioButton.text = "Rat"
        option2RadioButton.text = "Rije’"
        option3RadioButton.text = "Röj"

        palabras2.text = "Ustedes"
        option1RadioButton2.text = "Rïx"
        option2RadioButton2.text = "Rïn"
        option3RadioButton2.text = "Rat"

        palabras3.text = "Ellos y Ellas"
        option1RadioButton3.text = "Rije’"
        option2RadioButton3.text = "Rija"
        option3RadioButton3.text = "Rïn"
