...
class auPronombresActivity : AppCompatActivity() {
    private lateinit var mediaPlayer1: MediaPlayer
    private lateinit var mediaPlayer2: MediaPlayer
    private lateinit var mediaPlayer3: MediaPlayer
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_au_pronombres)
        ...
        option1RadioButton.text = "Él y ella"
        option2RadioButton.text = "Ellos y ellas"
        option3RadioButton.text = "Nosotros"

        audio2.text = "Reproducir Audio"
        option1RadioButton2.text = "Ustedes"
        option2RadioButton2.text = "Tu"
        option3RadioButton2.text = "Yo"

        audio3.text = "Reproducir Audio"
        option1RadioButton3.text = "Ellos y ellas"
        option2RadioButton3.text = "Ustedes"
        option3RadioButton3.text = "Tú"
        ...
        checkButton.setOnClickListener {
            ...
            val correctTranslation = "Él y ella"
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.el)
        mediaPlayer2 = MediaPlayer.create(this, R.raw.yo)
        mediaPlayer3 = MediaPlayer.create(this, R.raw.tu)
