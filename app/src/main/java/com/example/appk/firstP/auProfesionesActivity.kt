...
class auProfesionesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_au_profesiones)
        ...
        option1RadioButton.text = "Doctor"
        option2RadioButton.text = "Contador"
        option3RadioButton.text = "Comerciantes"

        audio2.text = "Reproducir Audio"
        option1RadioButton2.text = "Abogado"
        option2RadioButton2.text = "Agricultor"
        option3RadioButton2.text = "Policía"

        audio3.text = "Reproducir Audio"
        option1RadioButton3.text = "Panadero"
        option2RadioButton3.text = "Albañil"
        option3RadioButton3.text = "Maestro"
        ...
        checkButton.setOnClickListener {
            ...
            val correctTranslation = "Contador"
        ...
        checkButton2.setOnClickListener {
            ...
            val correctTranslation = "Policía"
            val userTranslation = selectedOption.text.toString()
        ...
        checkButton3.setOnClickListener {
            ...
            val correctTranslation = "Panadero"
            val userTranslation = selectedOption.text.toString()
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.contador)
        mediaPlayer2 = MediaPlayer.create(this, R.raw.policia)
        mediaPlayer3 = MediaPlayer.create(this, R.raw.panadero)
