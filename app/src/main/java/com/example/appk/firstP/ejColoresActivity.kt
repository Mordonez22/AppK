...
class ejColoresActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ej_colores)
        ...
        palabras.text = "Azul"
        option1RadioButton.text = "Xar"
        option2RadioButton.text = "Räx"
        option3RadioButton.text = "käq"

        palabras2.text = "Gris"
        option1RadioButton2.text = "Säq"
        option2RadioButton2.text = "q’ëq"
        option3RadioButton2.text = "chaj"

        palabras3.text = "Café"
        option1RadioButton3.text = "K’aqo’j"
        ...
        checkButton3.setOnClickListener {
            ...
            val correctTranslation = "K’aqo’j"
            val userTranslation = selectedOption.text.toString()
